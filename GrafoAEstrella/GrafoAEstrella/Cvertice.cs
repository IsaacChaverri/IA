...
namespace GrafoAEstrella
{
    class Cvertice
    {
        ...
        Dictionary<string, short> _banderas_predetermidas;
        ...
        public Cvertice(string Valor)
        {
            ...
            this._banderas_predetermidas = new Dictionary<string, short>();
        ...
        public void DibujarVertice(Graphics g)
        {
            ...
            g.DrawString(this.Valor, new Font("Arial", 12), new SolidBrush(color_fuente),
                this._posicion.X+15, this._posicion.Y, new StringFormat()
                {
